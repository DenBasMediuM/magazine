    ...
    (() => {
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                if (subMenu) {
                    const ativeLink = document.querySelector("._sub-menu-active");
                    const ativeBlock = document.querySelector("._sub-menu-open");
                    if (ativeLink && ativeLink !== targetElement) {
                        ativeLink.classList.remove("_sub-menu-active");
                        ativeBlock.classList.remove("_sub-menu-open");
